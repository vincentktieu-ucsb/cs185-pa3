      ...
      <header>
        ...
        <nav>
          <ul className="nav-links">
            <li>
              {TabId === 0 ? (
                <a className="page-selected" onClick={() => setTabId(0)}>
                  Text
                </a>
              ) : (
            ...
            <li>
              {TabId === 1 ? (
                <a className="page-selected" onClick={() => setTabId(1)}>
                  Images
                </a>
              ) : (
            ...
            <li>
              {TabId === 2 ? (
                <a className="page-selected" onClick={() => setTabId(2)}>
                  Videos
                </a>
              ) : (
            ...
            <li>
              {TabId === 3 ? (
                <a className="page-selected" onClick={() => setTabId(3)}>
                  Table
                </a>
              ) : (
            ...
            <li>
              {TabId === 4 ? (
                <a className="page-selected" onClick={() => setTabId(4)}>
                  Email
                </a>
              ) : (
