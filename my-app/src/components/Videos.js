    ...
    <>
      ...
      >
        ...
        <div className="center">
          <video className="modal-content" controls key={videoKey} ref={ModalVideoRef}>
      ...
      <div className="container">
        ...
        <div className="featured-section">
          <video className="featured" width="300px" height="200px" controls ref={Rick1Ref} onClick={() => activateModal(Rick1Ref, Rick1)}>
            <source src={Rick1} type="video/mp4" />
          </video>
          <video className="featured" width="300px" height="200px" controls ref={Rick2Ref} onClick={() => activateModal(Rick2Ref, Rick2)}>
            <source src={Rick2} type="video/mp4" />
          </video>
          <video className="featured" width="300px" height="200px" controls ref={Rick3Ref} onClick={() => activateModal(Rick3Ref, Rick3)}>
            <source src={Rick3} type="video/mp4" />
          </video>
          <video className="featured" width="300px" height="200px" controls ref={Rick4Ref} onClick={() => activateModal(Rick4Ref, Rick4)}>
